    ...
    return (
        <ScreenPageContainer>
            ...
            <div className="imprintContainer">
                <div className="imprintContentContainer">
                    <h1 className="imprintTitle">Imprint</h1>
                    ...
                    <div className="imprintSpacer" />
                    <h1 className="imprintTitle">Privacy Policy</h1>
                    <p className="imprintText">
                        At ExampleTech Solutions GmbH, we take the protection of
                        your personal data very seriously. Below, we outline how
                        we collect, use, and protect your information.
                    </p>
                    <h2 className="imprintSubtitle">1. Data Collection</h2>
                    <p className="imprintText">
                    ...
                    <h2 className="imprintSubtitle">2. Cookies</h2>
                    <p className="imprintText">
                    ...
                    <h2 className="imprintSubtitle">3. Data Usage</h2>
                    <p className="imprintText">
                    ...
                    <h2 className="imprintSubtitle">4. Data Protection</h2>
                    <p className="imprintText">
                    ...
                    <h2 className="imprintSubtitle">5. Your Rights</h2>
                    <p className="imprintText">
