...
const Dropdown = ({ label, options, value, defaultValue, onChange }) => {
    ...
    return (
        <div ref={dropdownRef} className="relative inline-block text-left">
            ...
            {isOpen && (
                <div className="z-10 absolute top-12 py-1 max-h-96 overflow-y-auto custom-scrollbar w-max min-w-full bg-primary-light border-[3px] border-primary-dark rounded-[24px] shadow-lg">
                    {options.map((option) => (
                        <div
                            key={option}
